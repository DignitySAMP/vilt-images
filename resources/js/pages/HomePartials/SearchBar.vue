<template>
    ...
    <div v-else-if="showFilterBar" class="grid grid-cols-1 md:grid-cols-[auto_auto_auto_1fr_auto] gap-4 items-center bg-white rounded-md p-4 border border-stone-200">
        ...
        <div class="col-span-2 w-full text-indigo-800">
        ...
        <button class="flex items-center w-full gap-6 bg-indigo-500 text-white text-sm px-4 py-2 rounded-md hover:bg-indigo-600 transition duration-200 cursor-pointer">
            <IconClick/>
            <span>
                Search
            </span>
