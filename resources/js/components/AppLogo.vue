<template>
    <Link :href="route('home')" class="gap-2 flex items-center bg-clip-text font-extrabold bg-gradient-to-br from-indigo-700 to-indigo-500 text-indigo-600 p-2 hover:scale-105 transition duration-300">
        <span class="w-8 h-8">
